package com.interco.e.daggerrxretrofit.base.adapter
...
import com.interco.e.daggerrxretrofit.base.viewholder.BaseViewHolder
 ...
 *
 * @param <ITEMS>  type of objects, which will be used in the adapter's dataset
 * @param <LISTNER>  click listener []
 * @param <VIEWHOLDER> ViewHolder []
</VIEWHOLDER></LISTNER></ITEMS> */
abstract class GenericRecyclerAdapter<ITEMS, LISTNER : BaseRecyclerListener<*>, VIEWHOLDER : BaseViewHolder<ITEMS, LISTNER>>
/**
 * Base constructor.
...
(context: Context) : RecyclerView.Adapter<VIEWHOLDER>() {
    ...
    private var listener: LISTNER? = null
    ...
    fun removeItemByPositon(index: Int) {
        if (index > -1) {
     ...
     */
    fun setListener(listener: LISTNER) {
